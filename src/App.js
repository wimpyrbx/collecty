...
import RegionRatingManagement from './pages/admin/RegionRatingManagement';
import ProductSites from './pages/admin/ProductSites';
...
import GroupTypeManagement from './pages/admin/GroupTypeManagement';
